...
const Footer = () => {
  ...
  return (
    <footer className="bg-violet-lighter m-auto max-w-xl text-center text-lg font-semibold text-violet-bg flex justify-between p-8 rounded-t-xl fixed bottom-0 left-0 right-0">
      <div className="">
